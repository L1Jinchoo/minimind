...
class GenMindConfig(PretrainedConfig):
    model_type = "Genmind"
...
class Attention(nn.Module):
    def __init__(self, args: GenMindConfig):
        super().__init__()
...
class MokioMindBlock(nn.Module):
    def __init__(self, layer_id: int, config: GenMindConfig):
        super().__init__()
...
class GenMindForCausalLM(PreTrainedModel, GenerationMixin):
    config_class = GenMindConfig
